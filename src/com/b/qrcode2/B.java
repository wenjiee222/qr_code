...
public class B{
	...
	public static void main(String[] args) throws IOException {
		...
		String str = "BEGIN:VCARD\r\n" +
		   ...
		   "TITLE:学生\r\n" + 
		   "TEL;WORK;VOICE:2418948941\r\n"+
		   "TEL;HOME;VOICE:148941519797\r\n"+
		   "TEL;CELL;VOICE:159878956\r\n"+
		   "ADR;WORK:河北科技师范学院\r\n"+
		   "ADR;HOME:河北秦皇岛\r\n"+
		   "URL:http://www.baidu.com\r\n "+
		   	"EMAIL;HOME:2231458197@qq.com\r\n" + 
		   "END:VCARD";
		...
		bufferedImage.flush();
		//输出二维码图片
		ImageIO.write(bufferedImage, "png", new File("d:/qrcode3.png"));
